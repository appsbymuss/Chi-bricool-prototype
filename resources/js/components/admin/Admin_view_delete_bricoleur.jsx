...
const Admin_view_delete_bricoleur = () => {
  ...
  return (
    ...
    <div className='p-2 mt-4'  style={{"color":"orange","font-family":"Arail Black"}}>
            <h1 style={{'fontWeight':'bold'}}>{t('Admin_View_Bricoleurs')}</h1>
    </div>
                        ...
                        clients?.map(client => {
                            ...
                            <tr key={client.id}>
                                ...
                                <td>
                                        ...
                                        <Link to={`delete_posts_bricoleurs/${client.id}`}><button>{t('Profile_Posts')}</button></Link>
                                </td>
                            </tr>
                            </>  
                            }  
...
export default Admin_view_delete_bricoleur